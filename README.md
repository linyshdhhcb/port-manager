...
│                        端口管理工具                              │
├─────────────────────────────────────────────────────────────────┤
│ 协议 │ 本地地址      │ 端口  │ 外部地址      │ 状态      │ PID   │ 进程名称 │
├─────────────────────────────────────────────────────────────────┤
│ TCP  │ 0.0.0.0      │ 80    │ 0.0.0.0:0     │ LISTENING │ 1234  │ nginx.exe │
│ TCP  │ 127.0.0.1    │ 3306  │ 0.0.0.0:0     │ LISTENING │ 5678  │ mysqld.exe │
│ UDP  │ 0.0.0.0      │ 53    │ *:*           │           │ 9012  │ dns.exe   │
└─────────────────────────────────────────────────────────────────┘
│ [搜索框] [搜索] [刷新] [停止自动刷新] [关闭选中端口]              │
│ 端口信息已更新，共 264 个端口 (自动刷新中...)                    │
└─────────────────────────────────────────────────────────────────┘
```
